...
class EmbeddingService:
    # Инициализация модели для генерации эмбеддингов. Размер embedding vector для модели "all-MiniLM-L6-v2" составляет 384. Это означает, что каждый текст будет представлен в виде вектора из 384 чисел, которые отражают его семантическое содержание
